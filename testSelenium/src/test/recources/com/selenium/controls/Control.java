...
public class Control {
	 ...
	 * 
	 * @param name="descriptiveName">name
	 *            of the element which will appear in the generated report
	 * @param name="criterion">By
	 *            expression which uniquely identifies the element in the web
	 *            page
	 */
	...
	public boolean IsVisible() {
		...
		if (_webElement != null) {
			...
			// Reporter.Info(this.GetDescriptiveName() + " is " + (result ?
			// "visible" : "not visible"));
		} else {
			TakeScreenShot.ScreenShot();
	...
	public void AssertElementIsNotPresent() {
		if (TestContextDriver.GetWebDriver().findElements(this.criterion).size() == 0) {
	...
	/**
	 * Gets the subclass name. This is used as a test element type. The
	 * subclasses are Button, TextBox, etc...
	 * 
	 * @return
	 */
	public String GetDescriptiveName() {
		String controlType = this.getClass().getTypeName();
